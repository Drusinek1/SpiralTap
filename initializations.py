...
process_start = DT.datetime(2012, 1, 1, 1, 1, 1) # yr,mon,dy,hr,min,sec
process_end = DT.datetime(2015, 12, 31, 1, 1, 1)
...
DTT_files = ["dttable_355_0135-072102.xdr",
             "dttable_532_11296-021009_30m.xdr",
             "dttable_1064par_8351-021009_30m.xdr",
             "dttable_1064per_8346-021009_30m.xdr"]

# IWG1 records per second. Please make it a float!
IWG1_hz = 1.0
# IWG1 data file
IWG1_file = "IWG1.21Oct2019-2040.txt"
...
cpl_pitch_offset = -0.017
cpl_pitch_roll_factor = (1.0/48.0)
...
if (os.name != 'nt'): # IF UNIX-BASED MACHINE, DEFINE DIRECTORIES HERE
    ...
    # ******** DEFINE ALL DIRECTORIES ********
    # Set the directory of the raw data
    raw_dir = 'E:\\CPL\\'+proj_name+'\\'+sortie+'\\'
    # Set the directory of the L0 data
    L0_dir = 'E:\\CPL\\'+proj_name+'\\L0\\'
    # Set the directory of the L1 data
    L1_dir = 'E:\\CPL\\'+proj_name+'\\L1\\'
    # Set the directory of the L2 data
    L2_dir = 'E:\\CPL\\'+proj_name+'\\L2\\'
    # Set the directory that contains configuration files
    config_dir = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Config\\'
    # The source directory
    source_dir = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Source\\L1A\\'
    # Directory to put output
    out_dir = 'E:\\CPL\\'+proj_name+'\\analysis\\'
    # Directory and name of library containing C codes
    clib_path = source_dir + 'C_lib_Win64\\CAMAL_C_lib_Win64\\x64\\Release\\'
    clib = 'CAMAL_C_lib_Win64.dll'
    # Directory containing dead time files
    dtt_dir = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Config\\'
    # Directory containing overlap files
    olap_dir = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Config\\'
    # Directory and name of the DEM
    DEM_dir = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Config\\DEM\\'
    DEM_name = 'JPL-CloudSat.dem'
    # Directory and name of C++ library with functions to read in DEM
    DEM_lib_path = 'C:\\Users\\akupchoc.NDC\\PycharmProjects\\Source\\DEM_reader_code\\JPL_DEM_CPP_DLL\\x64\\Release\\'
